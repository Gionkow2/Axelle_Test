      ...
      <div className="shell relative grid items-center gap-14 md:grid-cols-2 md:gap-10">
        ...
        <div className="relative mx-auto grid w-full max-w-[30rem] place-items-center py-8">
          <ParallaxLayer
            ...
            speed={-7}
            aria-hidden
            className="absolute inset-0 m-auto aspect-square w-[24rem] rounded-full bg-fresh/40"
          >
            <span className="sr-only" />
          </ParallaxLayer>
          <div className="gift-card-visual relative aspect-[8/5] w-[92%] overflow-hidden rounded-[var(--radius-card)] bg-shadow p-8 text-pale shadow-[0_14px_36px_-28px_rgba(38,64,5,0.4)]">
            <EnsoMark
        ...
        {/* copy — heading, body and CTA drift together as one block */}
        <ParallaxLayer
          as="div"
          speed={motion.gift.headingShift}
          className="max-w-md"
        >
          <h2 className="display-2 text-shadow">{giftCard.title}</h2>
